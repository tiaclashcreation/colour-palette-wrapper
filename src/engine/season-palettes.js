...
export const SEASON_PALETTES = {
  ...
  lightSpring: {
    ...
    anchors: ["#ffd1a9", "#ffcf9c", "#f6b3a6", "#c8e3c2", "#a9dfdd", "#f9e7a3", "#f9f0dd"]
  },
  trueSummer: {
    warm: false,
    chroma: "soft",
    ...
    anchors: ["#d4a6b1", "#b58aa0", "#b7a5d8", "#8aa4d6", "#445a7a", "#9f5f80", "#eef1f7"]
  },
  softAutumn: {
    warm: true,
    chroma: "soft",
  ...
  trueAutumn: {
    ...
    anchors: ["#b35a2e", "#cc7722", "#708238", "#3e5f3a", "#2f6f6d", "#b08d3e", "#8f3b2e"]
  },
  coolSummer: {
    warm: false,
    chroma: "soft",
  ...
  trueWinter: {
    ...
    anchors: ["#d80032", "#0047ab", "#008a5b", "#c2185b", "#4b2e83", "#f3dfff", "#ffffff"]
  },
  deepWinter: {
    warm: false,
    chroma: "bright",
